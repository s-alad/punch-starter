...
import { CVAR, exampleCreator } from "@/utils/constant";
            ...
            <div className={s.left}>
              ...
              <div className={s.detail}>
                <div className={s.raised}>
                  ...
                  <p>
                    {project.raised || 0} / {project.goal}{" "}
                    {denomination[project.chain]}
                  </p>
                </div>
              </div>
              ...
              {puncher && (
                <>
                  {!funding ? (
                    <button className={s.fund} onClick={() => setFunding(true)}>
                      fund!
                    </button>
                  ) : (
                  ...
                  <button
                    className={s.dao}
                    onClick={() => router.push(`/projects/${project.pid}/dao`)}
                  >
                    dao!
                  </button>
            ...
            <div className={s.right}>
              ...
              <div className={s.commentswrapper}>
                <div className={s.top}>
                  <div
                    className={`${s.upvote} ${
                      puncher && project.upvoteslist?.includes(puncher!.uid)
                        ? s.upvoted
                        : ""
                    }`}
                    onClick={addUpvote}
